...
- Prism은 두께·절단면이 보이는 결정과 윗면·옆면·밑면이 보이는 석재 받침으로 구성한다. 받침은 고정하고 결정의 방향별 이미지와 단일 출구 표시가 90° 회전을 표현한다. 군락은 낮은 식재·이끼·작은 동반 꽃을 포함하며 밑동을 배경과 연결한다.
