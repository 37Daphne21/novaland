...
- Mission List 선택, EVE 안내와 World Map 행동 유도로 이어지는 흐름
...
봉인 상태에서는 Gray를 사용하고, 개방 이후에는 Pearl White 중심광과 네 시설 컬러가 연결되는 Aurora Gradient로 Harmony를 표현합니다.
...
- 프로필 표시
- 진행 상태 저장
- Explorer Log와 Explorer Passport를 제공하는 Explorer Archive
...
- 상태 전달
- Explorer 보조
- 시설별 동일 인물과 시설 Identity Color를 적용한 Hologram 사용
...
Explorer Archive · 탐험 기록

→

Explorer Archive · 탐험가 패스포트
...
- MAP 필수 자산 제작: 완료
- 프로젝트 기반과 공통 UI: 완료
- MAP PC 화면과 시설 선택 인터랙션: 마무리 중
- 현재 단계: MAP 전체 상태 UI와 반응형 검수
- 개발: 진행 중
