...
const translations = {
  ko: {
    ...
    'common.resetDialogMessage': 'Explorer 정보와 Intro 등록 상태가 삭제돼요. 언어 설정은 유지됩니다.',
  ...
  en: {
    ...
    'common.resetDialogMessage': 'Explorer information and Intro registration progress will be deleted. Your language setting will be kept.',
