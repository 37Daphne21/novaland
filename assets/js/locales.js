...
const translations = {
  ko: {
    ...
    'control.statusTitle': '열차 상태',
    'control.trainStopped': '운행 중단',
    'control.trainRunning': '정상 운행',
    'control.railConnection': '레일 연결',
    'control.systemCheck': '시스템 점검',
    'control.inspectionRequired': '점검 필요',
    'control.inspectionComplete': '정상',
    'control.nextDeparture': '다음 출발',
    'control.suspended': '대기 중',
    'control.departureReady': '준비 완료',
  ...
  en: {
    ...
    'control.statusTitle': 'TRAIN STATUS',
    ...
    'control.inspectionComplete': 'NORMAL',
    'control.nextDeparture': 'NEXT DEPARTURE',
    'control.suspended': 'ON HOLD',
    'control.departureReady': 'READY',
