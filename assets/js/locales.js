...
const translations = {
  ko: {
    ...
    'intro.passport.issue': 'Explorer Passport를 발급합니다.',
    'intro.passport.verify': '외부 공명 응답과 복구 권한을 확인합니다.',
    'intro.passport.record': '{name}님의 Explorer 식별 정보를 기록합니다.',
    'intro.passport.recordAnnounce': '{name}님의 Explorer 정보를 기록합니다.',
  ...
  en: {
    ...
    'intro.passport.verify': 'Verifying the external resonance response and restoration access.',
    'intro.passport.record': 'Recording Explorer identity information for {name}.',
    'intro.passport.recordAnnounce': 'Recording Explorer information for {name}.',
